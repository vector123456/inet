...
#include "inet/common/newqueue/contract/IPacketFilterFunction.h"
...
#define Register_Packet_Filter_Function(name, function) \
    class INET_API name : public ::inet::queue::CPacketFilterFunction { public: name() : CPacketFilterFunction(function) { } }; \
    Register_Class(name)
