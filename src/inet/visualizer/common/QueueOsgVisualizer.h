...
class INET_API QueueOsgVisualizer : public QueueVisualizerBase
{
  ...
  protected:
    class INET_API QueueOsgVisualization : public QueueVisualization {
      ...
      public:
        QueueOsgVisualization(NetworkNodeOsgVisualization *networkNodeVisualization, osg::Geode *figure, inet::queue::IPacketQueue *queue);
    };
  ...
  protected:
    ...
    virtual QueueVisualization *createQueueVisualization(inet::queue::IPacketQueue *queue) const override { return nullptr; }
    virtual void refreshQueueVisualization(const QueueVisualization *queueVisualization) const override { }
