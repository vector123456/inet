...
QueueCanvasVisualizer::QueueCanvasVisualization::QueueCanvasVisualization(NetworkNodeCanvasVisualization *networkNodeVisualization, QueueFigure *figure, inet::queue::IPacketQueue *queue) :
...
QueueVisualizerBase::QueueVisualization *QueueCanvasVisualizer::createQueueVisualization(inet::queue::IPacketQueue *queue) const
{
