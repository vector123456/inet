...
QueueOsgVisualizer::QueueOsgVisualization::QueueOsgVisualization(NetworkNodeOsgVisualization *networkNodeVisualization, osg::Geode *node, inet::queue::IPacketQueue *queue) :
...
QueueVisualizerBase::QueueVisualization *QueueOsgVisualizer::createQueueVisualization(inet::queue::IPacketQueue *queue) const
{
