...
class INET_API QueueVisualizerBase : public VisualizerBase
{
  protected:
    ...
    {
        public:
            std::vector<inet::queue::IPacketQueue *> queues;
    ...
    class INET_API QueueVisualization
    {
      ...
      public:
        QueueVisualization(inet::queue::IPacketQueue *queue);
  ...
  protected:
    ...
    virtual QueueVisualization *createQueueVisualization(inet::queue::IPacketQueue *queue) const = 0;
