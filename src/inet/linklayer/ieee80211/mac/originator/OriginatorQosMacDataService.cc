...
Packet *OriginatorQosMacDataService::aMsduAggregateIfNeeded(inet::queue::IPacketQueue *pendingQueue)
{
...
std::vector<Packet *> *OriginatorQosMacDataService::extractFramesToTransmit(inet::queue::IPacketQueue *pendingQueue)
{
